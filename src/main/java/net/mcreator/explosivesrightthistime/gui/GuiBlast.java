...
import net.mcreator.explosivesrightthistime.procedure.ProcedureBlastfurproc;
...
public class GuiBlast extends ElementsChemcraft.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 18, 19) {
				@Override
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 18, 41) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawTexturedModalRect(this.guiLeft + 41, this.guiTop + 19, 0, 0, 256, 256);
		}
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ProcedureBlastfurproc.executeProcedure($_dependencies);
			}
		}
